    ...
    <div className="flex flex-col gap-4">
      ...
      {totalRecords === 0 && (
        <div className="rounded-lg border border-border bg-muted/20 p-6 text-center text-sm text-muted-foreground">
          No step metrics found. Make sure <code className="text-xs bg-muted px-1 py-0.5 rounded">datasets/step_metrics_fixed.sql</code> has been imported into your database.
        </div>
      )}
